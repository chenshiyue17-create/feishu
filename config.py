...
def load_settings(env_file: Optional[str] = None) -> Settings:
    ...
    settings = Settings(
        ...
        xhs_retry_attempts=_env_int("XHS_RETRY_ATTEMPTS", env_values, default=2),
        xhs_retry_delay_seconds=_env_int("XHS_RETRY_DELAY_SECONDS", env_values, default=1),
        ...
        xhs_batch_account_jitter_seconds=_env_float("XHS_BATCH_ACCOUNT_JITTER_SECONDS", env_values, default=0.2),
        ...
        xhs_batch_retry_delay_seconds=_env_float("XHS_BATCH_RETRY_DELAY_SECONDS", env_values, default=6.0),
        xhs_batch_risk_retry_delay_seconds=_env_float("XHS_BATCH_RISK_RETRY_DELAY_SECONDS", env_values, default=12.0),
